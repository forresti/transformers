...
class SqueezeBertConfig(PretrainedConfig):
    ...
    Args:
        vocab_size (:obj:`int`, optional, defaults to 30522):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers.SqueezeBertModel`.
        ...
        type_vocab_size (:obj:`int`, optional, defaults to 2):
            The vocabulary size of the `token_type_ids` passed into :class:`~transformers.SqueezeBertModel`.
